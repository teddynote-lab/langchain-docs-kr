...
이 문서는 [AzionRetriever](/oss/javascript/langchain/retrieval) 시작하기를 도와드립니다. 모든 AzionRetriever 기능 및 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/_langchain_community.retrievers_azion_edgesql.AzionRetriever.html)를 참조하세요.
