...
<Tip>
**Mistral 모델을 로컬에서 실행하고 싶으신가요? [Ollama 통합](/oss/javascript/integrations/chat/ollama)을 확인해보세요.**
</Tip>
<Warning>
현재 Mistral 모델을 텍스트 완성 모델로 사용하는 방법을 설명하는 페이지를 보고 계십니다. Mistral에서 제공하는 많은 인기 모델은 [채팅 완성 모델](/oss/javascript/langchain/models)입니다.

[이 페이지](/oss/javascript/integrations/chat/mistral/)를 찾고 계실 수 있습니다.
</Warning>
