...
LangChain은 다양한 chat & embedding model, tool & toolkit, document loader, vector store 등과 통합됩니다.

이러한 provider들은 개선된 버전 관리, 의존성 관리 및 테스트를 위해 독립적인 `langchain-provider` package를 제공합니다.
...
[모든 provider 보기](/oss/javascript/integrations/providers/all_providers) 또는 검색 필드를 사용하여 provider를 검색하세요.

<Info>
    integration을 기여하고 싶으시다면, [Integration 기여하기](/oss/javascript/contributing#add-a-new-integration)를 참조하세요.
</Info>
