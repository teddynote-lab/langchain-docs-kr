...
더 가벼운 솔루션을 원하고 로드하려는 웹페이지가 JavaScript 렌더링을 필요로 하지 않는다면, 대신 [`CheerioWebBaseLoader`](/oss/javascript/integrations/document_loaders/web_loaders/web_cheerio)를 사용할 수 있습니다.
