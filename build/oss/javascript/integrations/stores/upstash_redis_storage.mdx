...
이 예제는 `UpstashRedisStore` [`BaseStore`](https://langchain-ai.github.io/langgraphjs/reference/classes/checkpoint.BaseStore.html) 통합을 사용하여 채팅 기록 저장소를 설정하는 방법을 보여줍니다.
