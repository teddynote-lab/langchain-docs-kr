...
이 문서는 [LocalFileStore](/oss/javascript/integrations/stores) 시작하기를 도와드립니다. 모든 LocalFileStore 기능 및 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain.storage_file_system.LocalFileStore.html)를 참조하세요.
