...
Web Browser Tool은 agent에게 웹사이트를 방문하고 정보를 추출할 수 있는 능력을 제공합니다. 이는 agent에게 다음과 같이 설명됩니다
...
- Agent가 URL만으로 호출하면 웹사이트 콘텐츠의 요약을 생성합니다
- Agent가 URL과 찾고자 하는 내용에 대한 설명과 함께 호출하면 in-memory Vector Store를 사용하여 가장 관련성 높은 스니펫을 찾아 요약합니다

## Setup

Web Browser Tool을 사용하려면 다음 의존성을 설치해야 합니다:
