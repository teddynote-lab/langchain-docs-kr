...
JigsawStack Tool은 agent에게 다음과 같은 기능을 제공합니다:

- JigsawStackAIScrape: 고급 AI를 사용하여 웹 콘텐츠를 스크래핑합니다.

- JigsawStackAISearch: AI 기반 웹 검색을 수행하고 고품질 결과를 검색합니다.

- JigsawStackSpeechToText - Whisper large V3 AI model을 사용하여 비디오 및 오디오 파일을 텍스트로 변환합니다.

- JigsawStackVOCR - prompt를 사용하여 이미지를 인식, 설명 및 데이터를 추출합니다.

- JigsawStackTextToSQL - 텍스트에서 의미적으로 올바른 SQL 쿼리를 생성합니다.

## Setup

- [계정](https://jigsawstack.com/dashboard)을 설정하세요 (무료로 시작하기)
