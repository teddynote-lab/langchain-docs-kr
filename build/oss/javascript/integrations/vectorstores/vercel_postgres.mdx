...
자체 Postgres 인스턴스를 호스팅하려는 경우, LangChain의 [PGVector](/oss/javascript/integrations/vectorstores/pgvector) vectorstore 통합과 유사한 방식을 사용하고 connection string을 환경 변수로 설정하거나 위에 표시된 대로 설정할 수 있습니다.
