...
LanceDB는 AI 애플리케이션을 위한 임베디드 vector database입니다. Apache-2.0 라이선스로 배포되는 오픈 소스입니다.

LanceDB dataset은 디스크에 영구 저장되며 Node.js와 Python 간에 공유할 수 있습니다.

## Setup

[LanceDB](https://github.com/lancedb/lancedb) [Node.js bindings](https://www.npmjs.com/package/@lancedb/lancedb)를 설치하세요:
