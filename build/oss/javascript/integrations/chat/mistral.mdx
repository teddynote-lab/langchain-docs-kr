...
이 문서는 ChatMistralAI [chat models](/oss/javascript/langchain/models) 시작하기를 도와드립니다. 모든 ChatMistralAI 기능과 설정에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_mistralai.ChatMistralAI.html)를 참조하세요.
...
Mistral의 API는 일부 모델에 대해 [tool calling](/oss/javascript/langchain/tools)을 지원합니다. tool calling을 지원하는 모델은 [이 페이지](https://docs.mistral.ai/capabilities/function_calling/)에서 확인할 수 있습니다.
