...
이 문서는 ChatCerebras [chat models](/oss/javascript/langchain/models) 시작하는 데 도움이 됩니다. 모든 ChatCerebras 기능 및 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/_langchain_cerebras.ChatCerebras.html)를 참조하세요.
