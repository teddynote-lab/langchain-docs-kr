...
* **커스텀 출력 형식** – Main agent에게 다시 전달하기 전에 코드에서 subagent의 응답을 조정하거나 보강합니다.
  ...
  * 이를 위해서는 결과를 [`Command`](https://langchain-ai.github.io/langgraphjs/reference/classes/langgraph.Command.html) (또는 동등한 구조)로 래핑하여 커스텀 state를 subagent의 응답과 병합할 수 있어야 합니다.
