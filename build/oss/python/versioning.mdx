...
릴리스 상태 및 지원 일정에 대한 자세한 정보는 [Release policy](/oss/python/release-policy)를 참조하세요.
...
- [Release policy](/oss/python/release-policy) - 상세한 릴리스 및 deprecation 정책
- [Releases](/oss/python/releases) - 버전별 릴리스 노트 및 마이그레이션 가이드
