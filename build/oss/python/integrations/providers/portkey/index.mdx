...
Portkey는 OpenAI signature와 완전히 호환되므로 [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI/) 인터페이스를 통해 Portkey AI Gateway에 연결할 수 있습니다.
...
이제 LangChain의 [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI/) 모델을 업데이트하여 Portkey AI Gateway에 연결할 수 있습니다
...
AI gateway는 LangChain의 [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI/) 클래스를 확장하여 모든 제공업체와 모든 모델을 호출할 수 있는 단일 인터페이스로 만듭니다.
...
위와 같이 AI Gateway를 사용하도록 [`ChatOpenAI`](https://reference.langchain.com/python/integrations/langchain_openai/ChatOpenAI/) 클래스만 수정하면 됩니다.
