...
자세한 정보와 상세한 예제는 [xinference LLM 예제](/oss/python/integrations/llms/xinference)를 참조하세요.

### Embeddings

Xinference는 쿼리 및 문서 embedding도 지원합니다. 더 자세한 데모는 [xinference embedding 예제](/oss/python/integrations/text_embedding/xinference)를 참조하세요.
