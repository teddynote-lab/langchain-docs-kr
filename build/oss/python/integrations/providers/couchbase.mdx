...
[사용 예제](/oss/python/integrations/vectorstores/couchbase)를 참조하세요.
...
CouchbaseSemanticCache가 작동하려면 Search Index가 정의되어 있어야 합니다. 인덱스 설정 방법은 [사용 예제](/oss/python/integrations/vectorstores/couchbase)를 참조하세요.
