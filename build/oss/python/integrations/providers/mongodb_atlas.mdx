...
[상세 구성 지침](/oss/python/integrations/vectorstores/mongodb_atlas)을 참조하세요.
...
[사용 예제](/oss/python/integrations/vectorstores/mongodb_atlas)를 참조하세요.
...
MongoDBAtlasSemanticCache는 `MongoDBAtlasVectorSearch`를 상속하며 작동하려면 Atlas Vector Search Index가 정의되어 있어야 합니다. index 설정 방법은 [사용 예제](/oss/python/integrations/vectorstores/mongodb_atlas)를 참조하세요.
