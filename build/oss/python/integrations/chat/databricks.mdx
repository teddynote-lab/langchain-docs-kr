...
이 가이드는 Databricks [chat models](/oss/python/langchain/models) 시작하기에 대한 간단한 개요를 제공합니다. ChatDatabricks의 모든 기능과 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/community/chat_models/langchain_community.chat_models.databricks.ChatDatabricks.html)를 참조하세요.
...
chain에서 UC function을 사용하는 방법에 대해서는 [Databricks Unity Catalog](/oss/python/integrations/tools/databricks)를 참조하세요.
