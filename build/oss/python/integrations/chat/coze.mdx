---
title: Coze Bot과 채팅하기
---

coze.com의 ChatCoze 채팅 모델 API입니다. 자세한 내용은 [https://www.coze.com/open/docs/chat](https://www.coze.com/open/docs/chat)을 참조하세요.
...
또는 다음과 같이 API key와 API base를 설정할 수 있습니다:
