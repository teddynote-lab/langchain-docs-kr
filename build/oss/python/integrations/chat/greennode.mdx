...
이 페이지는 GreenNode Serverless AI [chat models](/oss/python/langchain/models) 시작을 도와드립니다. ChatGreenNode의 모든 기능과 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/greennode/chat_models/langchain_greennode.chat_models.ChatGreenNode.html)를 참조하세요.
