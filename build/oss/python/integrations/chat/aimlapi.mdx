...
이 가이드는 AI/ML API [chat models](/oss/python/langchain/models) 시작하기를 도와줍니다. 모든 `ChatAimlapi` 기능과 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/aimlapi/chat_models/langchain_aimlapi.chat_models.ChatAimlapi.html)를 참조하세요.
