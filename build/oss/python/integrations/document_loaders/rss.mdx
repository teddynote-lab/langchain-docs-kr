...
이 문서는 RSS feed URL 목록에서 HTML 뉴스 기사를 로드하여 다운스트림에서 사용할 수 있는 document 형식으로 변환하는 방법을 다룹니다.
...
기사를 로드하는 데 사용할 인수를 NewsURLLoader에 전달할 수 있습니다.
...
Feedly export와 같은 OPML 파일을 사용할 수도 있습니다. URL 또는 OPML 내용을 전달하세요.
