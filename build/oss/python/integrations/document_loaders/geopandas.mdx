...
예제 입력으로 [`Open City Data`](/oss/python/integrations/document_loaders/open_city_data)에서 GeoPandas dataframe을 생성합니다.
...
다운스트림 처리(embedding, chat 등)를 위해 GeoPandas dataframe을 [`Document`](https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document)로 로드합니다.
