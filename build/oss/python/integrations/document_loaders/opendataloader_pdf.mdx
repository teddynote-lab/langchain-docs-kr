...
빠른 휴리스틱 규칙 기반 추론으로 구동되며, 로컬 머신에서 완전히 실행되고 대용량 문서 세트에 대한 높은 처리량을 제공합니다.
...
`OpenDataLoaderPDFLoader` 컴포넌트를 사용하면 PDF를 구조화된 [`Document`](https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document) 객체로 파싱할 수 있습니다.
