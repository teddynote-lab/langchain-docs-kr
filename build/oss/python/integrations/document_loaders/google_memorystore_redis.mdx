...
이 노트북은 [Memorystore for Redis](https://cloud.google.com/memorystore/docs/redis/memorystore-for-redis-overview)를 사용하여 `MemorystoreDocumentLoader`와 `MemorystoreDocumentSaver`로 [langchain 문서를 저장, 로드 및 삭제](/oss/python/integrations/document_loaders)하는 방법을 다룹니다.
