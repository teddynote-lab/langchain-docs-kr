...
이 패키지는 웹 콘텐츠를 위한 [document loader](/oss/python/integrations/document_loaders/)를 구현합니다. 기존 웹 스크래퍼와 달리, PullMdLoader는 React, Angular, Vue.js와 같은 동적 JavaScript 프레임워크로 구축된 웹 페이지를 로컬 렌더링 없이 Markdown으로 변환할 수 있습니다.
