...
[설정 섹션](#setting-up)의 모든 import 외에도 텍스트에서 구조화된 정보를 추출하는 데 사용될 `LLMGraphTransformer`와 [`Document`](https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document)를 import하세요.
