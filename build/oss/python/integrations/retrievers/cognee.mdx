...
이 문서는 Cognee [retriever](/oss/python/langchain/retrieval) 시작하기를 도와드립니다. 모든 CogneeRetriever 기능과 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/community/retrievers/langchain_community.retrievers.cognee.CogneeRetriever.html)를 참조하세요.
