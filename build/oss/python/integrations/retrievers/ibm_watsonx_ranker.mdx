...
`WatsonxEmbeddings`를 초기화합니다. 자세한 내용은 [WatsonxEmbeddings](/oss/python/integrations/text_embedding/ibm_watsonx)를 참조하세요.
...
`ChatWatsonx`를 초기화합니다. 자세한 내용은 [ChatWatsonx](/oss/python/integrations/chat/ibm_watsonx)를 참조하세요.
