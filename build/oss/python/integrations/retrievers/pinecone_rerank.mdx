...
- `.compress_documents(documents, query)` (metadata에 `relevance_score`가 포함된 [`Document`](https://reference.langchain.com/python/langchain_core/documents/#langchain_core.documents.base.Document) 객체를 반환합니다)
