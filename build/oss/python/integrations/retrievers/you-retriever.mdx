...
>[you.com API](https://api.you.com)는 LLM의 출력을 학습 데이터셋에 포함되지 않았을 수 있는 가장 최신의, 가장 정확한, 가장 관련성 높은 정보로 보강하도록 돕기 위해 설계된 도구 모음입니다.

## Setup

retriever는 `langchain-community` 패키지에 있습니다.
