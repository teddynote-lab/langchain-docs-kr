...
>[Qdrant](https://qdrant.tech/)는 오픈소스 고성능 vector search engine/database입니다.

>`QdrantSparseVectorRetriever`는 문서 검색을 위해 `Qdrant` [v1.7.0](https://qdrant.tech/articles/qdrant-1.7.x/)에서 도입된 [sparse vectors](https://qdrant.tech/articles/sparse-vectors/)를 사용합니다.

'qdrant_client' package를 설치하세요:
