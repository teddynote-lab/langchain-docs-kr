...
[`OpenAIEmbeddings`](https://reference.langchain.com/python/integrations/langchain_openai/OpenAIEmbeddings/)를 가정하지만, Azure OpenAI를 사용하는 경우 대신 [`AzureOpenAIEmbeddings`](https://reference.langchain.com/python/integrations/langchain_openai/AzureOpenAIEmbeddings/)를 import하세요.
...
[`OpenAIEmbeddings`](https://reference.langchain.com/python/integrations/langchain_openai/OpenAIEmbeddings/) 및 AzureSearch 클래스의 인스턴스를 생성하세요. 이 단계를 완료하면 Azure AI Search 리소스에 빈 검색 인덱스가 생성됩니다. 통합 모듈은 기본 스키마를 제공합니다.
