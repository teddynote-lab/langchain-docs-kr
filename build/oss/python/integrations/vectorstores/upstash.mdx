...
또한, 주어진 텍스트를 embedding으로 변환하기 위해 [`Embeddings`](https://reference.langchain.com/python/langchain_core/embeddings/#langchain_core.embeddings.embeddings.Embeddings) 인스턴스가 필요합니다. 여기서는 예시로 `OpenAIEmbeddings`를 사용합니다
