...
LangChain의 [`VectorStore`](https://reference.langchain.com/python/langchain_core/vectorstores/?h=#langchain_core.vectorstores.base.VectorStore)는 스키마에 대해 다음과 같은 레이아웃을 기대합니다:
