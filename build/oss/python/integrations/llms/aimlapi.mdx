...
<Warning>
**현재 AI/ML API 모델을 text completion 모델로 사용하는 방법을 설명하는 페이지를 보고 계십니다. 최신의 가장 인기 있는 AI/ML API 모델 대부분은 [chat completion 모델](/oss/python/langchain/models)입니다.**

[이 페이지](/oss/python/integrations/chat/aimlapi)를 찾고 계실 수 있습니다.
</Warning>
