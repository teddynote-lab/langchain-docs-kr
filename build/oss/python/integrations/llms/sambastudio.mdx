...
<Warning>
**현재 SambaStudio 모델을 text completion 모델로 사용하는 방법을 설명하는 페이지입니다. [chat completion 모델](/oss/python/langchain/models) 사용을 권장합니다.**

[SambaStudio Chat Models](/oss/python/integrations/chat/sambastudio/)를 찾고 계실 수 있습니다.
</Warning>
