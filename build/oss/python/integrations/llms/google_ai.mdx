...
<Warning>
**현재 Google 모델을 text completion 모델로 사용하는 방법을 설명하는 페이지를 보고 계십니다. 많은 인기 있는 Google 모델은 [chat completion 모델](/oss/python/langchain/models)입니다.**

[이 페이지](/oss/python/integrations/chat/google_generative_ai/)를 찾고 계실 수 있습니다.
</Warning>

LangChain과 함께 [Google Generative AI](https://developers.generativeai.google/) 모델을 사용하는 가이드입니다. 참고: 이는 Google Cloud Vertex AI [통합](/oss/python/integrations/llms/google_vertex_ai_palm)과는 별개입니다.
