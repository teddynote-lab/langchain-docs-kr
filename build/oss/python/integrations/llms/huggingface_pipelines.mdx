...
자세한 내용은 [OpenVINO LLM guide](https://docs.openvino.ai/2024/learn-openvino/llm_inference_guide.html)와 [OpenVINO Local Pipelines notebook](/oss/python/integrations/llms/openvino/)을 참조하세요.
