...
공식 웹사이트: [www.xfyun.cn/doc/spark/Embedding_new_api.html](https://www.xfyun.cn/doc/spark/Embedding_new_api.html)

이 embedding model을 사용하려면 API key가 필요합니다. [platform.SparkLLM-ai.com/docs/text-Embedding](https://platform.SparkLLM-ai.com/docs/text-Embedding)에서 등록하여 발급받을 수 있습니다.

SparkLLMTextEmbeddings는 2K token window를 지원하며 2560 차원의 vector를 생성합니다.
