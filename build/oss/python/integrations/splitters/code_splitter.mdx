...
@[RecursiveCharacterTextSplitter]는 특정 프로그래밍 언어로 [텍스트를 분할](/oss/python/integrations/splitters/)하는 데 유용한 사전 구축된 구분자 목록을 포함하고 있습니다.

지원되는 언어는 `langchain_text_splitters.Language` enum에 저장되어 있습니다. 포함된 언어는 다음과 같습니다:
