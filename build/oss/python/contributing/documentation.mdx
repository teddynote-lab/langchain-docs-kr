...
접근 가능한 문서는 LangChain의 핵심 요소입니다. 새로운 기능/[통합](/oss/python/contributing/publish-langchain#adding-documentation)에 대한 문서뿐만 아니라 기존 문서에 대한 커뮤니티 개선도 환영합니다.
...
<CardGroup cols={2}>
    ...
    <Card title="튜토리얼 (Learn)" icon="graduation-cap" href="/oss/python/learn">
