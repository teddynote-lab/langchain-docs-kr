...
[`create_agent`](https://reference.langchain.com/python/langchain/agents/#langchain.agents.create_agent)에 전달하여 middleware를 추가하세요:
...
전체 예제 및 통합 패턴은 [human-in-the-loop 문서](/oss/python/langchain/human-in-the-loop)를 참조하세요.
</Note>
...
- [`@wrap_model_call`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.wrap_model_call) - 각 모델 호출 주위
- [`@wrap_tool_call`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.wrap_tool_call) - 각 도구 호출 주위
