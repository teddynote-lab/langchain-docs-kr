...
이 마이그레이션 가이드는 LangChain v1의 주요 변경 사항을 설명합니다. v1의 새로운 기능에 대해 자세히 알아보려면 [소개 게시물](/oss/releases/langchain-v1)을 참조하세요.
...
자세한 내용은 content blocks [참조](/oss/langchain/messages#content-block-reference)를 참조하세요.
...
<Note>
    자세히 알아보기: [Messages](/oss/langchain/messages#message-content) 및 [Standard content blocks](/oss/langchain/messages#standard-content-blocks). 입력 예제는 [Multimodal](/oss/langchain/messages#multimodal)을 참조하세요.
</Note>
