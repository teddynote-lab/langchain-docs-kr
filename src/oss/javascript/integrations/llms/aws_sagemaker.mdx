...
LangChain.js는 AWS SageMaker에서 호스팅되는 endpoint와의 통합을 지원합니다. 사용 가능한 모델 목록과 자체 모델 배포 방법은 [Amazon SageMaker JumpStart](https://aws.amazon.com/sagemaker/jumpstart/)를 확인하세요.

## Setup

공식 SageMaker SDK를 peer dependency로 설치해야 합니다:
