...
이 문서는 [Watsonx document compressor](/oss/concepts/#document_compressors) 시작하기를 도와드립니다. 모든 Watsonx document compressor 기능 및 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/modules/_langchain_community.document_compressors_ibm.html)를 참조하세요.
