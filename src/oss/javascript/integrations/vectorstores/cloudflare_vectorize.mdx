...
다음은 사용된 경로에 따라 vectorstore에 문서를 추가하거나, 쿼리하거나, 지우는 worker의 예시입니다. 또한 [Cloudflare Workers AI Embeddings](/oss/integrations/text_embedding/cloudflare_ai)를 사용합니다.
