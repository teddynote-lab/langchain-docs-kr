...
HtmlToTextTransformer를 사용하여 문서에서 HTML 태그를 제거하면 더 풍부한 콘텐츠의 청크를 생성할 수 있어 검색이 더 효과적으로 이루어집니다.

## Setup

[`html-to-text`](https://www.npmjs.com/package/html-to-text) npm package를 설치해야 합니다:
...
transformer에 [`html-to-text` package가 허용하는 모든 인수](https://www.npmjs.com/package/html-to-text)를 전달하여 작동 방식을 사용자 정의할 수 있습니다.