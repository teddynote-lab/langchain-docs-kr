...
이 노트북은 [CheerioWebBaseLoader](/oss/integrations/document_loaders/)를 시작하기 위한 간단한 개요를 제공합니다. CheerioWebBaseLoader의 모든 기능과 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_community_document_loaders_web_cheerio.CheerioWebBaseLoader.html)를 참조하세요.
