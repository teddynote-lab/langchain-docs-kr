...
이 노트북은 [PuppeteerWebBaseLoader](/oss/integrations/document_loaders/) 시작하기에 대한 간단한 개요를 제공합니다. 모든 PuppeteerWebBaseLoader 기능 및 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_community_document_loaders_web_puppeteer.PuppeteerWebBaseLoader.html)를 참조하세요.
...
더 가벼운 솔루션을 원하고 로드하려는 웹 페이지가 JavaScript 렌더링을 필요로 하지 않는 경우, [CheerioWebBaseLoader](/oss/integrations/document_loaders/web_loaders/web_cheerio)를 대신 사용할 수 있습니다.
