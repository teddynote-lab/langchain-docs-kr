...
이 가이드는 LangChain을 사용하여 CohereEmbeddings [embedding models](/oss/integrations/text_embedding)를 시작하는 데 도움을 드립니다. `CohereEmbeddings`의 기능 및 구성 옵션에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_cohere.CohereEmbeddings.html)를 참조하세요.
