...
이 가이드는 LangChain을 사용하여 Cloudflare Workers AI [embedding models](/oss/integrations/text_embedding)를 시작하는 데 도움을 드립니다. `CloudflareWorkersAIEmbeddings`의 기능 및 구성 옵션에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_cloudflare.CloudflareWorkersAIEmbeddings.html)를 참조하세요.
...
다음은 [Cloudflare Vectorize vectorstore](/oss/integrations/vectorstores/cloudflare_vectorize/)와 함께 Workers AI embeddings를 사용하는 worker 예제입니다.
