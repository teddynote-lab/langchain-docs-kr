...
먼저 [`@langchain/baidu-qianfan`](https://www.npmjs.com/package/@langchain/baidu-qianfan) 패키지를 설치해야 합니다:
...
사용 가능한 모델: `ERNIE-Bot`,`ERNIE-Lite-8K`,`ERNIE-Bot-4`,`ERNIE-Speed-8K`,`ERNIE-Speed-128K`,`ERNIE-4.0-8K`,
`ERNIE-4.0-8K-Preview`,`ERNIE-3.5-8K`,`ERNIE-3.5-8K-Preview`,`ERNIE-Lite-8K`,`ERNIE-Tiny-8K`,`ERNIE-Character-8K`,
`ERNIE Speed-AppBuilder`

지원 중단된 모델: `ERNIE-Bot-turbo`
...
Qianfan의 API는 스트리밍 토큰 응답도 지원합니다. 아래 예제는 이 기능을 사용하는 방법을 보여줍니다.
