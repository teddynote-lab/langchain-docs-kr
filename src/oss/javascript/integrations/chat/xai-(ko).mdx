...
이 가이드는 `ChatXAI` [chat models](/oss/langchain/models) 시작하기를 도와드립니다. 모든 `ChatXAI` 기능과 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/_langchain_xai.ChatXAI.html)를 참조하세요.
