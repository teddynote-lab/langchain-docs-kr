...
이 문서는 `ChatVertexAI` [chat models](/oss/langchain/models) 시작하기를 도와드립니다. 모든 `ChatVertexAI` 기능 및 구성에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_google_vertexai.ChatVertexAI.html)를 참조하세요.
