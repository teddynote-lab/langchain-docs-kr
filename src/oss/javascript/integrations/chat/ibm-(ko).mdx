...
이 문서는 IBM watsonx.ai [chat models](/oss/langchain/models) 시작하기를 도와드립니다. 모든 `IBM watsonx.ai` 기능과 설정에 대한 자세한 문서는 [IBM watsonx.ai](https://api.js.langchain.com/modules/_langchain_community.chat_models_ibm.html)를 참조하세요.
