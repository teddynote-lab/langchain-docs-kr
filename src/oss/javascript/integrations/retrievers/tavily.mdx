...
이 문서는 Tavily Search API [retriever](/oss/langchain/retrieval) 시작하기를 도와줍니다. 모든 `TavilySearchAPIRetriever` 기능과 설정에 대한 자세한 문서는 [API reference](https://api.js.langchain.com/classes/langchain_community_retrievers_tavily_search_api.TavilySearchAPIRetriever.html)를 참조하세요.
