...
<Warning>
**현재 SambaNovaCloud 모델을 텍스트 완성 모델로 사용하는 방법을 설명하는 페이지를 보고 계십니다. [chat completion models](/oss/langchain/models) 사용을 권장합니다.**

[SambaNovaCloud Chat Models](/oss/integrations/chat/sambanova/)를 찾고 계실 수 있습니다.
</Warning>
