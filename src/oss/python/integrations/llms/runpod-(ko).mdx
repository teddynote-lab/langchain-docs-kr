...
2. **LLM Endpoint 배포:** [RunPod Provider 가이드](/oss/integrations/providers/runpod#setup)의 설정 단계를 따라 RunPod Serverless에 호환 가능한 텍스트 생성 endpoint를 배포하고 Endpoint ID를 얻으세요.
