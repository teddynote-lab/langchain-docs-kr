...
[Predibase](https://predibase.com/)를 사용하면 선형 회귀부터 대규모 언어 모델까지 모든 ML 모델을 학습, 미세 조정 및 배포할 수 있습니다.

이 예제는 Predibase에 배포된 모델과 함께 LangChain을 사용하는 방법을 보여줍니다.

# Setup

이 노트북을 실행하려면 [Predibase 계정](https://predibase.com/free-trial/?utm_source=langchain)과 [API key](https://docs.predibase.com/sdk-guide/intro)가 필요합니다.

또한 Predibase Python package를 설치해야 합니다:
...
## Fine-tuned LLM (Predibase에서 자체 미세 조정된 LLM 사용하기)
