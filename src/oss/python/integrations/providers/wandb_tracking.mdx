...
`WandbTracer`에 대해 자세히 알아보려면 [agent_with_wandb_tracing](/oss/integrations/providers/wandb_tracing) 노트북을 참조하거나 다음 [colab notebook](http://wandb.me/prompts-quickstart)을 사용하세요.
