...
표준 retrieval pipeline에서 [`ExaSearchRetriever`](/oss/integrations/tools/exa_search#using-exasearchretriever)를 사용할 수 있습니다. 다음과 같이 import할 수 있습니다.

[사용 예제](/oss/integrations/tools/exa_search)를 참조하세요.
...
[Exa tool calling 문서](/oss/integrations/tools/exa_search#use-within-an-agent)에 설명된 대로 Exa를 agent tool로 사용할 수 있습니다.
