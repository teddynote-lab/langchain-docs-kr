...
[사용 예제](/oss/integrations/chat/bedrock)를 참조하세요.
...
[사용 예제](/oss/integrations/llms/bedrock)를 참조하세요.
...
[사용 예제](/oss/integrations/llms/amazon_api_gateway)를 참조하세요.
...
[사용 예제](/oss/integrations/llms/sagemaker)를 참조하세요.
...
[사용 예제](/oss/integrations/text_embedding/bedrock)를 참조하세요.
```python
...
[사용 예제](/oss/integrations/text_embedding/sagemaker-endpoint)를 참조하세요.
```python
...
[S3DirectoryLoader 사용 예제](/oss/integrations/document_loaders/aws_s3_directory)를 참조하세요.

[S3FileLoader 사용 예제](/oss/integrations/document_loaders/aws_s3_file)를 참조하세요.
...
[사용 예제](/oss/integrations/document_loaders/amazon_textract)를 참조하세요.
...
[사용 예제](/oss/integrations/document_loaders/athena)를 참조하세요.
...
[사용 예제](/oss/integrations/document_loaders/glue_catalog)를 참조하세요.
...
[사용 예제](/oss/integrations/vectorstores/opensearch#using-aos-amazon-opensearch-service)를 참조하세요.
...
[자세한 구성 지침](/oss/integrations/vectorstores/documentdb)을 참조하세요.
...
[사용 예제](/oss/integrations/vectorstores/documentdb)를 참조하세요.
...
```
[사용 예제](/oss/integrations/vectorstores/memorydb)를 참조하세요.
...
[사용 예제](/oss/integrations/retrievers/amazon_kendra_retriever)를 참조하세요.
...
[사용 예제](/oss/integrations/retrievers/bedrock)를 참조하세요.
...
[사용 예제](/oss/integrations/tools/awslambda)를 참조하세요.
...
[사용 예제](/oss/integrations/graphs/amazon_neptune_open_cypher)를 참조하세요.
...
[사용 예제](/oss/integrations/callbacks/sagemaker_tracking)를 참조하세요.
