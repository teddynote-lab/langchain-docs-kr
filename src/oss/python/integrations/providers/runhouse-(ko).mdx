...
Self-hosted LLM에 대한 더 자세한 안내는 [이 노트북](/oss/integrations/llms/runhouse)을 참조하세요
...
Self-hosted Embedding에 대한 더 자세한 안내는 [이 노트북](/oss/integrations/text_embedding/self-hosted)을 참조하세요