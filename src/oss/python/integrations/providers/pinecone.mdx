...
Pinecone vectorstore에 대한 자세한 안내는 [이 notebook](/oss/integrations/vectorstores/pinecone)을 참조하세요.
...
자세한 안내는 [Pinecone Sparse Vector Store notebook](/oss/integrations/vectorstores/pinecone_sparse)을 참조하세요.
...
자세한 사용법은 [Pinecone Sparse Embeddings notebook](/oss/integrations/vectorstores/pinecone_sparse)을 참조하세요.
...
자세한 정보는 [이 notebook](/oss/integrations/retrievers/pinecone_hybrid_search)을 참조하세요.
