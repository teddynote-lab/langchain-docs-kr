...
이 노트북은 [Firestore](https://cloud.google.com/firestore)를 사용하여 `FirestoreLoader`와 `FirestoreSaver`로 [langchain 문서를 저장, 로드 및 삭제](/oss/integrations/document_loaders)하는 방법을 다룹니다.
