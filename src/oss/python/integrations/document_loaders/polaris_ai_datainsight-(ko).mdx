...
- `POLARIS_AI_DATA_INSIGHT_API_KEY`: Polaris AI DataInsight API key입니다. API key를 얻으려면 [Polaris AI DataInsight Documentation](https://datainsight.polarisoffice.com/api/keys)을 참조하세요.
...
그러면 아래와 같이 문서에서 추출된 내용과 metadata를 확인할 수 있습니다:
