...
이 노트북은 [Cloud SQL for MySQL](https://cloud.google.com/sql/mysql)을 사용하여 `MySQLLoader`와 `MySQLDocumentSaver`로 [langchain 문서를 저장, 로드 및 삭제](/oss/integrations/document_loaders)하는 방법을 다룹니다.
