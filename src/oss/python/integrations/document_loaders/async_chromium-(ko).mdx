...
아래 예제에서는 `AsyncChromiumLoader`를 사용하여 페이지를 로드한 다음, [`Html2TextTransformer`](/oss/integrations/document_transformers/html2text/)를 사용하여 HTML 태그 및 기타 의미론적 정보를 제거합니다.
