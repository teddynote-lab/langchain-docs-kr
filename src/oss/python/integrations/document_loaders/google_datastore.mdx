...
이 노트북은 [Firestore in Datastore Mode](https://cloud.google.com/datastore)를 사용하여 `DatastoreLoader`와 `DatastoreSaver`로 [langchain 문서를 저장, 로드 및 삭제](/oss/integrations/document_loaders)하는 방법을 다룹니다.
