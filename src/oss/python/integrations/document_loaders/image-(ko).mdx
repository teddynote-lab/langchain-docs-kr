...
`.jpg` 및 `.png`와 같은 다양한 이미지 형식을 처리하기 위해 [Unstructured](https://unstructured.io/)를 사용합니다. Unstructured를 로컬에서 설정하는 방법(필수 시스템 종속성 설정 포함)에 대한 자세한 내용은 [이 가이드](/oss/integrations/providers/unstructured/)를 참조하세요.
