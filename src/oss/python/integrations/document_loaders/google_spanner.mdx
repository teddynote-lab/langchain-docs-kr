...
이 노트북은 [Spanner](https://cloud.google.com/spanner)를 사용하여 `SpannerLoader`와 `SpannerDocumentSaver`로 [langchain 문서를 저장, 로드 및 삭제](/oss/integrations/document_loaders)하는 방법을 다룹니다.
