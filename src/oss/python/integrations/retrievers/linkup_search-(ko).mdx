...
이 문서는 LinkupSearchRetriever [retriever](/oss/langchain/retrieval/)를 시작하는 데 도움이 됩니다. LinkupSearchRetriever의 모든 기능과 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/linkup/retrievers/linkup_langchain.search_retriever.LinkupSearchRetriever.html)를 참조하세요.
