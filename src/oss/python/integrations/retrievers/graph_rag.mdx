...
메타데이터 속성의 **구조화된** 순회를 결합한 LangChain [retriever](/oss/langchain/retrieval/)를 제공합니다.
...
<Tabs groupId="vector-store" queryString>
    <Tab title="AstraDB">
      ...
      [AstraDB Vector Store 가이드](/oss/integrations/vectorstores/astradb)를 참조하세요.
    ...
    <Tab title="Apache Cassandra">
      ...
      [Apache Cassandra Vector Store 가이드](/oss/integrations/vectorstores/cassandra#connection-parameters)를 참조하세요
    ...
    <Tab title="OpenSearch">
      ...
      [OpenSearch Vector Store 가이드](/oss/integrations/vectorstores/opensearch)를 참조하세요.
        </div>
    </Tab>
    <Tab title="Chroma">
        <div style={{ paddingLeft: '30px' }}>
      ...
      [Chroma Vector Store 가이드](/oss/integrations/vectorstores/chroma)를 참조하세요.
