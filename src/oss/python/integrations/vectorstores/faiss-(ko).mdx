...
이 노트북은 `FAISS` vector database와 관련된 기능을 사용하는 방법을 보여줍니다. 이 통합에 특화된 기능을 보여줄 것입니다. 이 내용을 살펴본 후, [관련 사용 사례 페이지](/oss/langchain/rag)를 탐색하여 이 vectorstore를 더 큰 chain의 일부로 사용하는 방법을 배우는 것이 유용할 수 있습니다.
