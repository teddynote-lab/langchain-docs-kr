...
이 문서는 GMail [toolkit](/oss/langchain/tools#toolkits) 시작하기를 도와드립니다. 이 toolkit은 GMail API와 상호작용하여 메시지를 읽고, 초안을 작성하고, 메시지를 보내는 등의 작업을 수행합니다. 모든 GmailToolkit 기능 및 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/google_community/gmail/langchain_google_community.gmail.toolkit.GmailToolkit.html)를 참조하세요.
