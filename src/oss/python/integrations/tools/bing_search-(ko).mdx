...
여기서는 [agent](/oss/langchain/agents)의 일부로 사용하는 방법을 보여줍니다. OpenAI Functions Agent를 사용하므로 필요한 종속성을 설정하고 설치해야 합니다. 또한 [LangSmith Hub](https://smith.langchain.com/hub)를 사용하여 prompt를 가져오므로 이를 설치해야 합니다.
