...
이 가이드는 LinkupSearchTool [tool](/oss/langchain/tools) 시작하기에 대한 간단한 개요를 제공합니다. LinkupSearchTool의 모든 기능과 구성에 대한 자세한 문서는 [API reference](https://python.langchain.com/api_reference/linkup/tools/linkup_langchain.search_tool.LinkupSearchTool.html)를 참조하세요.
