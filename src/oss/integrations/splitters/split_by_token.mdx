...
Language model에는 token 제한이 있습니다. Token 제한을 초과해서는 안 됩니다. [텍스트를 chunk로 분할](/oss/integrations/splitters/)할 때 token 수를 세는 것이 좋습니다. 많은 tokenizer가 있습니다. 텍스트에서 token을 셀 때는 language model에서 사용하는 것과 동일한 tokenizer를 사용해야 합니다.
